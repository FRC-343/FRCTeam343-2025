...
public class Constants {
    ...
    public static final class elevatorConstants{
        ...
        public static double L3Level = 0.0; //Placeholder replace with real value from robot
        public static double L4Level = 0.0; //Placeholder replace with real value from robot
